...
//            $where .= " AND l.updated_at > '$fromUpdatedAt'";
        ...
        l.person_uuid,
        l.learner_id,
        l.strongest_language_oid,
        l.maternal_status_oid,
        l.maternal_status_updated_at,
        l.disability_vision_oid,
        l.disability_hearing_oid,
        l.disability_mobility_oid,
        l.disability_cognition_oid,
        l.disability_selfcare_oid,
        l.disability_communication_oid,
