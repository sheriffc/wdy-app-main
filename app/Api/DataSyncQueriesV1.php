...
class DataSyncQueriesV1
{
    //UNI DIRECTIONAL
    public static function nonPayrollTeachers($fromUpdatedAt=false, $fromPk=false, $limit="", $where = ""){
        $pinFilter = "(pin IS NULL OR pin = '')";
        $cursor = ($fromUpdatedAt && $fromPk)
            ? "AND ( updated_at > '$fromUpdatedAt' OR (updated_at = '$fromUpdatedAt' AND uuid > '$fromPk') )"
            : "";

        return DB::select("
        SELECT uuid, school_sid, first_name, middle_name, last_name, sex, date_of_birth,
        pin, nin, nassit_number, created_at, updated_at, deleted_at
        FROM teacher_payroll
        WHERE $pinFilter $cursor
        ORDER BY uuid
        $limit
        ");
    }
...
//            $where = "WHERE (updated_at > '$fromUpdatedAt' OR uuid > '$fromPk')";
            $where = "WHERE ( updated_at > '$fromUpdatedAt' OR (updated_at = '$fromUpdatedAt' AND uuid > '$fromPk') )";
        }
...
//            $where = "WHERE (updated_at > '$fromUpdatedAt' OR id > '$fromPk')";
            $where = "WHERE ( updated_at > '$fromUpdatedAt' OR (updated_at = '$fromUpdatedAt' AND id > '$fromPk') )";
        }
    ...
    public static function optionListLink($fromUpdatedAt=false, $fromPk=false, $limit="", $where = ""){
        if($fromUpdatedAt && $fromPk){
//            $where = "WHERE (updated_at > '$fromUpdatedAt' OR id > '$fromPk')";
            $where = "WHERE ( updated_at > '$fromUpdatedAt' OR (updated_at = '$fromUpdatedAt' AND id > '$fromPk') )";
        }
...
//            $where .= " AND (l.updated_at > '$fromUpdatedAt' OR l.uuid > '$fromPk')";
            $where .= " AND ( l.updated_at > '$fromUpdatedAt' OR (l.updated_at = '$fromUpdatedAt' AND l.uuid > '$fromPk') )";
        }
...
//            $whereUpdate = "WHERE (u.updated_at > '$fromUpdatedAt' OR u.uuid > '$fromPk')";
            $whereUpdate = "WHERE ( u.updated_at > '$fromUpdatedAt' OR (u.updated_at = '$fromUpdatedAt' AND u.uuid > '$fromPk') )";
        }
...
//            $where .= " AND (updated_at > '$fromUpdatedAt' OR uuid > '$fromPk')";
            $where .= " AND ( updated_at > '$fromUpdatedAt' OR (updated_at = '$fromUpdatedAt' AND uuid > '$fromPk') )";
        }
...
//            $where .= " AND (sle.updated_at > '$fromUpdatedAt' OR sle.uuid > '$fromPk')";
            $where .= " AND ( sle.updated_at > '$fromUpdatedAt' OR (sle.updated_at = '$fromUpdatedAt' AND sle.uuid > '$fromPk') )";
        }
...
//            $where .= " AND (mp.updated_at > '$fromUpdatedAt' OR mp.uuid > '$fromPk')";
            $where .= " AND ( mp.updated_at > '$fromUpdatedAt' OR (mp.updated_at = '$fromUpdatedAt' AND mp.uuid > '$fromPk') )";
        }
...
//            $where .= " AND (pf.updated_at > '$fromUpdatedAt' OR pf.uuid > '$fromPk')";
            $where .= " AND ( pf.updated_at > '$fromUpdatedAt' OR (pf.updated_at = '$fromUpdatedAt' AND pf.uuid > '$fromPk') )";
        }
...
//            $where .= " AND (tt.updated_at > '$fromUpdatedAt' OR tt.uuid > '$fromPk')";
            $where .= " AND ( tt.updated_at > '$fromUpdatedAt' OR (tt.updated_at = '$fromUpdatedAt' AND tt.uuid > '$fromPk') )";
        }
