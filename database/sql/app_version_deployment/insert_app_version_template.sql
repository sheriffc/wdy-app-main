INSERT INTO app_version (
    ...
    , -- e.g. 'https://wideya.org/app-download' or 'https://demo.wideya.org/app-download'
    , -- e.g. 'TSC Wi De Ya App Installer SCHOOL v-013.apk'
    -- ** Values independent of app variant: **
    , -- e.g. 13
    , -- e.g. '3.2.0'
    , -- e.g. 4 (corresponds to AppDatabase.kt version)
    , -- set active to 0 if you don't want to deploy yet, or 1 if you do
    CONCAT(
    ...
    , -- e.g. '300-school phase: start of second half of rollout/training (northern half)'
    NOW()
 )
